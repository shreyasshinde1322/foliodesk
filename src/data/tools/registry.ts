...
export const TOOLS: ToolDefinition[] = [
  ...
  tool({
    ...
    featured: true,
    popular: true,
    relatedTools: ["image-compressor", "image-resizer", "image-editor", "metadata-cleaner"],
    description:
      "Convert images to JPG, PNG, WebP, or AVIF in your browser with quality and resize controls.",
    seo: {
      title: "Image Converter – Free Online JPG, PNG, WebP & AVIF Converter",
      description:
        "Convert images to JPG, PNG, WebP, or AVIF right in your browser. Quality control, resizing, batch conversion, and no uploads.",
