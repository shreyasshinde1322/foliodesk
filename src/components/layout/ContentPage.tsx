  ...
  return (
    <PageShell className="py-10">
      ...
      <article className="prose-legal mt-6 max-w-3xl">
        ...
        <div className="mt-6 space-y-4 text-base leading-relaxed text-muted [&_a]:text-primary [&_a]:underline [&_a]:underline-offset-2 [&_h2]:mt-8 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:text-text">
          {children}
        </div>
      </article>
    </PageShell>
